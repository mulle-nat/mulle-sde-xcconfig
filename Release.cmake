...
if( "${CMAKE_C_COMPILER_ID}" STREQUAL "Intel" or "${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC")
   set( OTHER_C_FLAGS "${OTHER_C_FLAGS} /O2 /Zo /DNDEBUG=1 ${UNWANTED_C_WARNINGS}  ${UNWANTED_OBJC_WARNINGS}")
else()
   set( OTHER_C_FLAGS "${OTHER_C_FLAGS} -O3 -DNDEBUG=1 ${UNWANTED_C_WARNINGS}  ${UNWANTED_OBJC_WARNINGS}")
endif()
